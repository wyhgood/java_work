...
@Entity(name = "user_comment_test")
//@Table(uniqueConstraints=@UniqueConstraint(
//		columnNames={"rawId","commentId"},name="uniqueIdx"))
public class UserCommentTest implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 3738501854802862794L;
	@Id
	...
	public UserComment myclone(){
		UserComment u = new UserComment();
		u.setAbsTags(getAbsTags());
		u.setBrandList(getBrandList());
		u.setBrandsTags(getBrandsTags());
		u.setCommentEnvriomentScore(getCommentEnvriomentScore());
		u.setCommentId(getCommentId());
		u.setCommentPics(getCommentPics());
		u.setCommentProdScore(getCommentProdScore());
		u.setComments(getComments());
		u.setCommentServiceScore(getCommentServiceScore());
		u.setCommentText(getCommentText());
		u.setCommentTime(getCommentTime());
		u.setCommentTitle(getCommentTitle());
		u.setDataLang(getDataLang());
		u.setDetail(getDetail());
		u.setLargeCommentPics(getLargeCommentPics());
		u.setLocation(getLocation());
		u.setPoUserPic(getPoUserPic());
		u.setRawId(getRawId());
		u.setStarLevel(getStarLevel());
		u.setStarTag(getStarTag());
		u.setTagList(getTagList());
		u.setUpdateTs(new Date());
		u.setUserId(getUserId());
		u.setUserName(getUserName());
		u.setUserPic(getUserPic());
		return u;
	}
}
