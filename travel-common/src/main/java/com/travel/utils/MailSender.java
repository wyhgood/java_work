...
public class MailSender {
	 ...
	 * 初始化方法
	 */
	public MailSender(boolean debug, String strConfPath) {

		try {
			properties.load(new FileInputStream(new File(strConfPath)));
	...
	public static void main(String[] args) {
		...
		// }
		String strConf = "conf/mail.properties";
		String strAttacheMent = "conf/mail.properties";
		String strTitle = "test_main";
		String strContent = "test_main";
		//String strDest = "xiewenbo1357@126.com";
		String strDest = "wangyahui@mxtrip.com";
